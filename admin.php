                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <?php if ($user->suspended) : ?>
                                <a href="_actions/unsuspend.php?id=<?= $user->id ?>" class="btn btn-sm btn-warning">BAN
                                </a>
                            <?php else : ?> 
                                <a href="_actions/suspend.php?id=<?= $user->id ?>" class="btn btn-sm btn-outline-warning">BAN
                                </a>
                            <?php endif ?>
                            <a href="_actions/delete.php?id=<?= $user->id ?>" class="btn btn-sm btn-outline-danger">DELETE
                            </a>
                        </div>
                    </td>
                </tr>
